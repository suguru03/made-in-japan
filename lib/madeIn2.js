...
class MadeIn {
  ...
  getRepositories(developers) {
    ...
    const info = {};
    return Aigle.eachSeries(developers, developer => {
  ...
  saveDevelopers() {
    ...
    fs.writeFileSync(filepath.engineer, JSON.stringify(developers, null, 2), 'utf8');
  }
  ...
  readRepositories() {
    this._repositories = require(filepath.repository);
  ...
  saveRepositories() {
    ...
    fs.writeFileSync(filepath.repository, JSON.stringify(repositories, null, 2), 'utf8');
  }
}
