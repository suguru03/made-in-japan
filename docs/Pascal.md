...
|8|[@LUXOPHIA](https://github.com/LUXOPHIA)/[**VolumeRender**](https://github.com/LUXOPHIA/VolumeRender)|３次元配列をボリュームレンダリングする方法。||
...
|6|[@LUXOPHIA](https://github.com/LUXOPHIA)/[**LUX.GPU.OpenGL**](https://github.com/LUXOPHIA/LUX.GPU.OpenGL)|OpenGL を扱うためのライブラリ。||
...
|4|[@LUXOPHIA](https://github.com/LUXOPHIA)/[**SearchBM**](https://github.com/LUXOPHIA/SearchBM)|Boyer-Moore String Search Algorithm を用いて、任意パターンの配列を高速に検索する方法。||
...
|3|[@LUXOPHIA](https://github.com/LUXOPHIA)/[**VideoFramer**](https://github.com/LUXOPHIA/VideoFramer)|OpenCV を用いて、動画ファイルからフレームを取り出す方法。||
